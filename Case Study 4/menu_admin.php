...
<div id="wrapper">
    ...
    <table>
        <tbody>
            <tr>
                <td><input type="checkbox" name="java_check" id="java_check" onclick="change1();"></td>
            ...
            <tr>
                <td><input type="checkbox" name="cafe_check" id="cafe_check" onclick="change2();"></td>
            ...
            <tr>
                <td><input type="checkbox" name="iced_check" id="iced_check" onclick="change3();"></td>
